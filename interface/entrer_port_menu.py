...
from utils import afficher_texte, dict_couleurs, largeur_fenetre, hauteur_fenetre, mettre_à_jour_port, \
...
def main():
    ...
    continue_button = Boutton(x=largeur_fenetre // 2, y=350, largeur=300, hauteur=50, texte="Continuer", couleur=dict_couleurs["boutton"], montrer=False)
