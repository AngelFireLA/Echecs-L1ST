...
boutton_reprendre = boutton.Boutton(largeur_fenetre // 2, hauteur_fenetre // 2 - 100, 400, 100, "Reprendre", dict_couleurs["boutton"])
#boutton_options = boutton.Boutton(largeur_fenetre // 2, hauteur_fenetre // 2 + 50, 400, 100, "Options", dict_couleurs["boutton"])

def main():
    en_cours = True
    clock = pygame.time.Clock()
    fenetre = pygame.display.set_mode((largeur_fenetre, hauteur_fenetre))
    pygame.display.set_caption("Partie d'Échecs en Pause")
    while en_cours:
