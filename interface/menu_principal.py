...
boutton_solo = boutton.Boutton(largeur_fenetre // 2, hauteur_fenetre // 2 - 100, 350, 75, "Solo", dict_couleurs["boutton"])
boutton_local = boutton.Boutton(largeur_fenetre // 2, hauteur_fenetre // 2, 350, 75, "1v1 Local", dict_couleurs["boutton"])
boutton_multijoueur = boutton.Boutton(largeur_fenetre // 2, hauteur_fenetre // 2 + 100, 350, 75, "Multijoueur", dict_couleurs["boutton"])
boutton_options = boutton.Boutton(largeur_fenetre // 2, hauteur_fenetre // 2 + 200, 350, 75, "Options", dict_couleurs["boutton"])
def main():
    clock = pygame.time.Clock()
    fenetre = pygame.display.set_mode((largeur_fenetre, hauteur_fenetre))
    pygame.display.set_caption("Menu Échecs")
    while True:
        ...
        afficher_texte(fenetre, largeur_fenetre//2, 75, "Échecs", 100, couleur=dict_couleurs["bleu marin"])
